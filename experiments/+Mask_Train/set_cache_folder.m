function model = set_cache_folder(cache_base_proposal, cache_base_mask, model)
...
% --------------------------------------------------------
    ...
    model.stage2_rpn.cache_name = ...
            ...
            cache_base_mask, '_stage2_rpn'];

    model.stage2_mask.cache_name = ...
            [cache_base_proposal, ...
            strrep(sprintf('_top%d_nms%g_top%d', model.stage2_rpn.nms.per_nms_topN, ...
            model.stage2_rpn.nms.nms_overlap_thres, model.stage2_rpn.nms.after_nms_topN), '.', '_'), ...
            cache_base_mask, '_stage2_mask'];

    model.final_model.cache_name = [cache_base_proposal, cache_base_mask];
end
